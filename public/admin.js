...
async function _rCC(){
  ...
  var kindToggle='<div style="display:flex;gap:6px;margin-bottom:10px"><button class="'+(_cck==='prepress'?'_btn':'_btnG')+'" style="flex:1" onclick="_sCCK(\'prepress\')">Prepress</button><button class="'+(_cck==='postpress'?'_btn':'_btnG')+'" style="flex:1" onclick="_sCCK(\'postpress\')">Postpress</button></div>';
